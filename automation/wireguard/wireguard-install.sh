...
# This script is a modified version of the original by angristan: https://github.com/angristan/wireguard-install
# Modifications include:
# - Added support for Amazon Linux.
# - Automates some variables by sourcing from a .env file, which is generated by wireguard-setup.sh.
